...
public class Experiment extends LinearOpMode {
    ...
    private void holdElevatorPosition() {
        ...
        rightElevator.setTargetPosition(rightElevatorPosition);
        leftElevator.setTargetPosition(leftElevatorPosition);

        rightElevator.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        leftElevator.setMode(DcMotor.RunMode.RUN_TO_POSITION);

        rightElevator.setPower(0.2); // Small power to maintain position
        leftElevator.setPower(0.2);  // Small power to maintain position
    }
}